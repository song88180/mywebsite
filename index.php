...
<script type="text/javascript">
    ...
    document.write(unescape("%3Cspan id='cnzz_stat_icon_1274577988'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s19.cnzz.com/z_stat.php%3Fid%3D1274577988%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));
    document.write(unescape("%3Cspan id='cnzz_stat_icon_1274577988'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s19.cnzz.com/z_stat.php%3Fid%3D1274577988%26online%3D1' type='text/javascript'%3E%3C/script%3E"));
</script>
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-124726633-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'UA-124726633-1');
</script>
</body>
</html>
